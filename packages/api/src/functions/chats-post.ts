...
const ragSystemPrompt = `Assistant helps the Zava company customers with questions about the products. Be brief in your answers. Answer only plain text, DO NOT use Markdown.
