...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'Comment peindre du mobilier jardin?',
    'Quelle peinture pour peindre des murs intérieur?',
    'Comment préparer un support?',
  ],
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Posez une question ou essayez un exemple',
    citationsTitle: 'Sources :',
    followUpQuestionsTitle: 'Questions complémentaires :',
    chatInputPlaceholder: 'Posez-moi une question...',
    chatInputButtonLabel: 'Envoyer',
    assistant: 'Assistant',
    user: 'Vous',
    errorMessage: 'Un problème est survenu.',
    newChatButton: 'Nouvelle conversation',
